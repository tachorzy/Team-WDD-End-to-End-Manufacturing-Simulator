...
describe("Landing Page Component", () => {
    test("renders Landing Page Title corretly and it's components ", () => {
        ...
        const title = screen.getByText(
            /^(End-to-End)(Manufacturing Simulator)$/,
        );
        const header2 = screen.getByText(
        ...
        expect(title).toHaveClass(
            "font-semibold bg-gradient-to-br from-DarkGray via-[#555F68] to-DarkGray bg-clip-text text-transparent text-3xl text-center md:text-4xl lg:text-5xl xl:text-6xl pb-4",
        );
