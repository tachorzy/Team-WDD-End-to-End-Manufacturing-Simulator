        ...
        <div className="flex flex-row gap-x-16 mt-6 gap-y-2">
            ...
            <section>
                <div className="flex flex-col w-full gap-y-3">
                    <AttributeInputColumn attributes={contextValue?.attributes} />
                    <AddAttributeButton setAttributes={contextValue?.setAttributes} />
                </div>
            </section>
            <section className="flex flex-row w-[30%] gap-y-3 gap-x-4">
                <div className="flex flex-col gap-y-2">
                    ...
                    <p className="text-base font-medium text-[#494949]">
                        <span className="text-MainBlue font-semibold">Attributes</span> are inherent qualities of a model that remain constant in the simulation. You can define the attributes of your model and asisgn them their values here.
                    </p>
                    <p className="text-base font-medium text-[#494949]">
                        Common attributes include the model's name, serial number and type.
                    </p>
                </div>
            </section>
    </div>
