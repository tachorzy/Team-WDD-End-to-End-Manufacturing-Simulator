...
const SineWaveGeneratorForm = () => {
    return (
        <div className="flex flex-col gap-y-3 max-h-72">
            <div>
                <h1 className="text-2xl font-semibold text-gray-900">Properties</h1>
                <div className="flex flex-row gap-x-1">
                    <Image src="/icons/generation/sine-waves.svg" width={20} height={20} alt="sine wave"></Image>
                    <h2 className="text-sm font-medium text-DarkBlue">Sine wave function</h2>
                </div>
            </div>
