    ...
    const mockModels: Model[] = [
        {
            ...
            factoryId: "factory-1",
            attributes: [
                { factoryId: "factory-1", modelId: "1", name: "Height", value: "10 meters" },
                { factoryId: "factory-1", modelId: "1", name: "Weight", value: "500 kg" },
                { factoryId: "factory-1", modelId: "1", name: "Color", value: "Blue" }
            ],
            properties: [
                { factoryId: "factory-1", modelId: "1", measurementId: "1", name: "Temperature", unit: "Celsius", generatorType: "constant" },
                { factoryId: "factory-1", modelId: "1", measurementId: "2", name: "Voltage", unit: "Volts", generatorType: "sine wave" },
                { factoryId: "factory-1", modelId: "1", measurementId: "3", name: "Pressure", unit: "Pascal", generatorType: "sawtooth" }
            ]
        },
        {
            modelId: "model-2",
            factoryId: "factory-1",
            attributes: [
                { factoryId: "factory-1", modelId: "2", name: "Height", value: "12 meters" },
                { factoryId: "factory-1", modelId: "2", name: "Weight", value: "600 kg" },
                { factoryId: "factory-1", modelId: "2", name: "Color", value: "Red" }
            ],
            properties: [
                { factoryId: "factory-1", modelId: "2", measurementId: "4", name: "Temperature", unit: "Celsius", generatorType: "sine wave" },
                { factoryId: "factory-1", modelId: "2", measurementId: "5", name: "Voltage", unit: "Volts", generatorType: "sawtooth" },
                { factoryId: "factory-1", modelId: "2", measurementId: "6", name: "Pressure", unit: "Pascal", generatorType: "constant" }
            ]
        },
    ];
                ...
                <tbody>
                    {currentAssets.map((model, index) => (
                        ...
                        >
                            ...
                            {model.properties && model.properties.map((property, index) => (
                                    <div key={index}>
