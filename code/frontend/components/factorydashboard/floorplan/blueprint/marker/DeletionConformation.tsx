...
const DeletionConfirmation: React.FC<DeletionConfirmationProps> = ({ confirmDelete, cancelDelete }) => {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70" data-testid="confirm-dialog">
