        ...
        isDraggableVisible && (
            ...
            >
                <div className="group flex flex-col absolute top-0 left-0 z-10 drop-shadow-md items-center">
                    ...
                    {showButtons && (
                        <div
                            className={`absolute ${isCloseToLeft ? "left-full" : "right-full"} top-1/2 transform -translate-y-1/2 bg-white shadow-lg rounded-xl p-6 min-w-max w-96 h-auto flex flex-col justify-between no-drag`}
                        >
                            <div className="">
